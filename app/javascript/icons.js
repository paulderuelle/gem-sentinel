...
const icons = {
  ...
  IconFolderOpen: <FontAwesomeIcon icon={['fas', 'folder-open']} className='card-ico' />,
  IconChartColumn: <FontAwesomeIcon icon={['fas', 'chart-column']} className='container-ico' />,
  IconGem: <FontAwesomeIcon icon={['fas', 'gem']} className= '' />,
  IconCodeCommit: <FontAwesomeIcon icon={['fas', 'code-commit']} className='container-ico' />,
  IconCircleInfo: <FontAwesomeIcon icon={['fas', 'circle-info']} className= '' />,
